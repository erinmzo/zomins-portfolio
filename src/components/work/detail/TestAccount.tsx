...
function TestAccount({ testId, testPw, link }: TestAccountProps) {
  return (
    <div className="mb-[40px]">
      <div className="flex flex-col md:flex-row md:items-end justify-between my-8 md:my-0 py-5 md:py-8 border-t border-b border-black text-[18px] gap-4 md:gap-0">
        {/* Desktop Layout */}
        ...
        <div className="flex flex-col md:hidden gap-4">
          <div className="flex flex-col gap-4 text-[12px]">
            <div className="grid grid-cols-[80px_1fr] gap-8">
              ...
              <span className="leading-none">test@test.com</span>
            </div>
            <div className="grid grid-cols-[80px_1fr] gap-8">
      ...
      <div className="md:hidden bg-[#f5f5f5] rounded-[12px] py-4 w-full text-center">
        {link === "" ? (
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center font-bold gap-1 leading-none"
          >
            VISIT SITE
            <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1 1L7 7.84091L1 15" stroke="black" strokeWidth="2" />
