  ...
  return (
    <Page>
      <div className="flex items-center justify-center min-h-screen w-full">
        <div className="flex flex-col gap-[68px] md:items-center justify-center w-full max-w-7xl px-4 md:px-6">
          ...
          <p className="text-white text-left md:text-center text-[20px] md:text-[32px] leading-relaxed font-medium md:w-[85%] md:break-normal">
            ...
            소통과 지식 공유를 통해 함께 성장하는 개발 문화를 만들어가고자 합니다. 현재는 Next.js와 Tailwind CSS를
            활용한 프론트엔드 개발에 주력하며, 기술적 도전을 통해 성장하는 것을 즐기고 있습니다.
          </p>
        </div>
      </div>
    </Page>
