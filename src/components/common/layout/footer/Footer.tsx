...
function Footer() {
  return (
    <footer className="bg-black pt-[16px] pb-[20px] md:py-[40px] ">
      <div className="w-full max-[390px] md:max-w-[1440px] px-4 md:px-12 mx-auto">
        <div className="text-blue text-[44px] md:text-[104px] leading-[48px] md:leading-none text-center md:text-left">
