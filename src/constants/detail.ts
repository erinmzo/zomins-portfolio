    ...
    features: [
      {
        title: "공간 스타일링",
        description:
          "레어로우의 시그니처 제품들로 구성된 오피스 공간을 소개합니다. 각 공간마다 특별히 선정된 가구들의 배치와 스타일링을 통해 실용적이면서도 감각적인 공간 구성을 보여줍니다.",
      },
      {
        title: "제품 상세 정보",
        description:
          "공간에 배치된 레어로우 가구들의 상세 정보를 확인할 수 있습니다. 각 제품의 사이즈, 소재, 컬러 등 디테일한 정보부터 공간 속 활용 방법까지 자세히 소개합니다.",
      },
      {
        title: "반응형 디자인",
        description:
          "모바일과 데스크톱 환경에서 최적화된 뷰를 제공합니다. 다양한 디바이스에서도 편리하게 공간을 둘러볼 수 있도록 설계되어 있으며, 고해상도 이미지를 통해 섬세한 디테일까지 확인할 수 있습니다.",
      },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        title: "같이 사 공구템",
        description:
          "자취템 공동구매 서비스를 통해 사용자들은 생활용품을 보다 저렴한 가격에 구매할 수 있습니다. 공동구매 주최자는 상품 정보, 가격, 공구 기간, 최소 인원 등을 설정하여 공구를 열 수 있으며, 참여자들과 실시간 채팅을 통해 소통할 수 있습니다. 또한 지역별로 공구 모집이 가능하여 배송비를 절약하고 더 효율적인 구매가 가능합니다. 결제 시스템과 연동되어 안전한 거래를 보장합니다.",
      },
      {
        title: "랜덤박스 구매",
        description:
          "랜덤박스 상품 결제 서비스는 자취 필수템들을 묶어 패키지로 제공하는 특별한 쇼핑 경험을 제공합니다. 사용자는 가격대별로 다양한 랜덤박스를 선택할 수 있으며, 각 박스에는 계절별, 테마별로 엄선된 자취 필수품들이 포함되어 있습니다. 포트원 결제 시스템을 통해 안전한 결제가 가능하며, 배송 조회와 구매 내역 확인 기능을 제공합니다. 특히 처음 자취를 시작하는 사용자들에게 필요한 기본 생활용품을 합리적인 가격에 제공하는 것이 특징입니다.",
      },
    ],
    ...
    trobleShooting: [
      ...
      {
        title: "Supabase Storage Egress 트래픽 초과",
        problem:
    ...
    features: [
      {
        title: "기존 기능 개선",
        description:
          "구해줘 자취템과 같이 사 공구템, 랜덤박스 구매 등 기존 기능들의 성능과 안정성을 개선했습니다. 특히 찜하기 기능의 캐싱 처리를 최적화하여 더욱 안정적인 상태 관리가 가능해졌으며, 이미지 업로드 컴포넌트를 재사용 가능한 형태로 개선하여 코드의 재사용성과 유지보수성을 높였습니다.",
      },
      {
        title: "코드 구조화",
        description:
